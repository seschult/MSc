...
\newcommand{\thesistitle}{Studies for the Measurement of the Top-Quark Mass in the $t\bar{t}\rightarrow$ lepton + jets Channel, with $\sqrt{s}$=13~TeV Proton-Proton Collision Data from the ATLAS Experiment}
\newcommand{\thesistitlem}{Studien zur Messung der Top-Quark Masse im $t\bar{t}\rightarrow$ lepton + jets Kanal, unter Verwendung von Daten aus $\sqrt{s}$=13~TeV Proton-Proton Kollisionen, aufgezeichnet mit dem ATLAS Experiment}
