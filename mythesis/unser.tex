...
\begin{figure} % "[t!]" placement specifier just for this example
	...
	\begin{subfigure}{0.4\textwidth}
		...
		\caption{1D variation of the JES$_{\rm Flavour Composition}$ of $m_{\text{top}}$. } \label{fig:Sy1}
	...
	\begin{subfigure}{0.40\textwidth}
		...
		\caption{2D variation of the JES$_{\rm Flavour Composition}$ of $m_{\text{top}}$.  } \label{fig:Sy2}
	\end{subfigure}
	\begin{subfigure}{0.40\textwidth}
		\includegraphics[width=\linewidth]{OutputFolder_PE_Syst_Plots/{PlotParameter_JES_Flavour_Com_jsf_250PE_2D}.pdf}
		\caption{2D variation of the JES$_{\rm Flavour Composition}$ of JSF. } \label{fig:Sy3}
	\end{subfigure}\hspace*{0.5cm}
